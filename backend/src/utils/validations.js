...
const registerValidation = [
  ...
  body("businessId")
    .trim()
    .notEmpty()
    .withMessage("Business ID is required2")
...
const completeProfileValidation = [
  body("businessId")
    .trim()
    .notEmpty()
    .withMessage("Business ID is required1")
    .isLength({ min: 3, max: 50 })
    .withMessage("Business ID must be between 3 and 50 characters")
    .matches(/^[a-zA-Z0-9_-]+$/)
    .withMessage(
      "Business ID can only contain letters, numbers, underscores, and hyphens",
    ),
];
...
const updateCustomerBalanceValidation = [
  body("amount").isNumeric().withMessage("Amount must be a number"),
...
const updateVendorBalanceValidation = [
  body("amount").isNumeric().withMessage("Amount must be a number"),
...
const updateSaleStatusValidation = [
  body("status")
    .notEmpty()
    .withMessage("Status is required")
    .isIn(["pending", "completed"])
...
const updatePurchaseStatusValidation = [
  body("status")
    .notEmpty()
    .withMessage("Status is required")
    .isIn(["pending", "completed"])
...
module.exports = {
  ...
  // Purchases Transaction validations
